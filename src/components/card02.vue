        ...
        <div class="px-2 text-xs text-left">
          <div class="grid grid-cols-10">
            ...
            <div class="col-span-9">
              <a :href="f.website" target="_blank">{{ shorten(f.website) }}</a>
            </div>
            <socials />
          </div>
        </div>
